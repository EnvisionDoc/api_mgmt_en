...
latex_elements = {
    ...
    'preamble': r'''
        ...
        \fancyfoot[R]{\ifthenelse{\isodd{\value{page}}}{{\tiny EnOS API Management} }{\href{https://www.envisioniot.com}{\tiny Envision digital}}}
    ...
    'maketitle': r'''
        ...
        \begin{titlepage}
            ...
            \fontsize{40pt}{\baselineskip}\selectfont \textbf{API Management}
...
latex_documents = [
    (master_doc, u'EnOSDocumentationCenter.tex', u'EnOS API Management',
...
man_pages = [
    (master_doc, u'enosdocumentationcenter', u'EnOS API Management',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EnOSDocumentationCenter', 'EnOS API Management',
